...
export declare class NativeClarityBinProvider implements Provider {
     ...
     */
    static create(allocations: InitialAllocation[], dbFilePath: string, clarityBinPath: string): Promise<NativeClarityBinProvider>;
    /**
    ...
    readonly allocations: InitialAllocation[];
